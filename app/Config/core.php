 ...
 */
	//ref random http://passwordsgenerator.net/
	Configure::write('Security.salt', 'adLRW2qv9Fc1LhI1vD9wptW91cF27sr9sV1nynXP');
// 	Configure::write('Security.salt', 'DYhG93b0qyJfIxfs2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '39743379481769614812863181706');
